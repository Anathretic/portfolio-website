export const ExtraItem = ({ color, title, icon, subtitle, href, ...otherProps }) => {
	return (
		<a
			...
			rel='noreferrer'
			{...otherProps}
			className='flex flex-row justify-start items-center p-4 m-2 cursor-pointer hover:bg-[#192445] white-gradient text-white transition duration-300 md:w-9/12 max-w-screen-lg md:h-[175px] mf:h-[150px]'>
