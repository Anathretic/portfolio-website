...
export const TechStackIcons = [
	...
	{ id: 59, icon: <FaBootstrap />, color: 'text-[#6529b3]', link: 'https://getbootstrap.com/', timeout: 2750 },
	...
	{ id: 62, icon: <SiVite />, color: 'text-[#6500d9]', link: 'https://vitejs.dev/', timeout: 1600 },
	{ id: 63, icon: <FaGulp />, color: 'text-[#de4747]', link: 'https://gulpjs.com/', timeout: 3250 },
	{ id: 64, icon: <SiWebpack />, color: 'text-[#1938b5]', link: 'https://webpack.js.org/', timeout: 900 },
	{ id: 65, icon: <SiJest />, color: 'text-[#4c0252]', link: 'https://jestjs.io/', timeout: 1300 },
